...
<div class="page-top">
            <div class="container">
                <div class="row">
                    <div Sub="col-md-12">
                        <h2>{{$subcategory_data->subcategory_name}}</h2>
                        <nav class="breadcrumb-container">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('Home')}}">{{HOME}}</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{$subcategory_data->subcategory_name}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="category-page-post-item">
                                        ...
                                        <div class="category">
                                            <span class="badge bg-success">{{$subcategory_data->subcategory_name}}</span>
                                        </div>
