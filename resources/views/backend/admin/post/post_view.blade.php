...
@section('button')
                        <a href="{{route('postCreate')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
@endsection
 @section('content')
                                                ...
                                                <td>{{$loop->iteration}}</td>
                                                   ...
                                                   <td>
                                                    ...
                                                    @endif
                                                     ...
                                                     <a href="{{ route('postEdit',$row->id)}}" class="btn btn-primary" >Edit</a>
                                                     <a href="{{ route('postDelete',$row->id)}}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
