...
@section('button')
                        <a href="{{route('post')}}" class="btn btn-primary"><i class="fas fa-eye"></i> View</a>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="language_id" class="form-control">
                                ...
                                <option value="{{$row->id}}" @if($row->id == $post->language_id) selected @endif>{{$row->name}} </option>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <td>{{$item->tag_name}}</td>
                            <td>
                                <a  href="{{route('postDelete',[$item->id,$post->id])}}" onClick="return confirm('Are you sure?');">Delete</a>
                            </td>
                            </tr>
                            @endforeach
                           </table>
