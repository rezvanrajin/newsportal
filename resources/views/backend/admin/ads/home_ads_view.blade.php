...
@section('heading', 'Home Ads')

@section('content')

<div class="section-body">
    <form action="{{route('HomeAdsUpdate')}}" method="post" enctype="multipart/form-data">
       @csrf
       <input type="hidden" value="{{$home_ads->id}}" name="ads_id">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <label>URL</label>
                            <input type="text" class="form-control" name="above_search_ad_url" value="{{$home_ads->above_search_ad_url}}">
                        </div>
                        <div class="form-group mb-3">
                            <label>Status</label>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <label>URL</label>
                            <input type="text" class="form-control" name="above_footer_ad_url" value="{{$home_ads->above_footer_ad_url}}">
                        </div>
                        <div class="form-group mb-3">
                            <label>Status</label>
